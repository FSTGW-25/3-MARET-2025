...
<body>
  <div class="title-box">14 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 15.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-My My.mp3');
    ...
    const fullMessage = `Kesuksesan tidak pernah datang dalam semalam 🌻. Ia adalah hasil dari usaha kecil yang dilakukan dengan penuh kesabaran 🌼 dan keyakinan 🌈, hari demi hari. Kadang terasa lelah karena hasilnya tak kunjung terlihat 🌿, tetapi ingatlah 🤍, setiap langkah kecil yang diambil membawa semakin dekat pada tujuan yang diimpikan ✨. Yang perlu diingat 🌷, kesuksesan bukan hanya soal apa yang dicapai 🚀, tetapi juga siapa diri ini menjadi selama perjalanan itu 🌼. Setiap tantangan yang muncul adalah kesempatan untuk belajar 🌿, bertumbuh 🌈, dan memperkuat diri 🤍. Berikan waktu untuk diri sendiri 🌻, dan percayalah bahwa segala usaha yang tulus tidak akan pernah sia-sia ✨.`;
